...
public class PanelFrontalSudoku extends javax.swing.JFrame {

    public static TableroSudoku tableroSudoku;
    private TableroNumeros tableroNumeros;
    private PanelNiveles fromNiveles;
    private boolean estadoCrear;

    private int xPos;
    private int yPos;

    public PanelFrontalSudoku() {
        initComponents();
        iniciarComponentes();
    ...
    public void iniciarComponentes() {
        ...
        tableroSudoku.setTxtBackground2(new Color(204, 204, 204));
        tableroSudoku.setTxtForeground2(Color.BLACK);
        tableroSudoku.setTxtBackground3(new Color(102, 255, 102));
        tableroSudoku.setTxtForeground3(Color.WHITE);
        tableroSudoku.setTxtBackground4(new Color(102, 255, 102));
    ...
    private void initComponents() {
        ...
        panelFondo.setBackground(new java.awt.Color(0, 0, 153));
        ...
        jLabel2.setBounds(590, 0, 30, 30);

        jLabel3.setBackground(new java.awt.Color(255, 255, 255));
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Hecho por Haag Gomez Gaston Ivan  - Año  2024 -");
        panelFondo.add(jLabel3);
        jLabel3.setBounds(160, 20, 300, 20);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(panelFondo, javax.swing.GroupLayout.PREFERRED_SIZE, 620, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(panelFondo, javax.swing.GroupLayout.PREFERRED_SIZE, 420, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private void lblNuevaPartidaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblNuevaPartidaMousePressed
        if (fromNiveles != null) {
            ...
            fromNiveles = new PanelNiveles(tableroSudoku);
            fromNiveles.setVisible(true);
        }
